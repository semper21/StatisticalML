...
if __name__ == '__main__':
    ...
    X_train, X_test = normalize3(X_train, X_test)
    ...
    saver.save(sess, 'CNN_twoLayer_withoutVal')    
    ...
    outputFile = 'pred_CNN3Layer_5x32n5x64n1024nfc_withEqualizerwithDiffNorm_withoutVal_32000'    
